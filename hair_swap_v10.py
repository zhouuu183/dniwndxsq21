...
class HairFast_v10:
    """
    HairFast v10 inference entry point.

    This file is intentionally independent from hair_swap.py and previous
    experiment files. It reuses only shared foundation modules.
    """
    ...
    def __init__(self, args):
        ...
        self.align = Alignment_v10(args, self.embed.get_e4e_embed, net=self.net)
        self.blend = Blending_v10(args, net=self.net)
...
def get_parser_v10():
    parser = argparse.ArgumentParser(description="HairFast v10")
    ...
    parser.add_argument("--blending_v10_checkpoint", type=str, default="")
    parser.add_argument("--alpha_boundary_width_v10", type=int, default=9)
    parser.add_argument("--alpha_boundary_strength_v10", type=float, default=0.65)
    parser.add_argument("--alpha_fallback_blur_v10", type=int, default=9)
    parser.add_argument("--use_f64_bypass_v10", action="store_true", default=False)
    parser.add_argument("--disable_f64_bypass_v10", dest="use_f64_bypass_v10", action="store_false")
    parser.add_argument("--f64_bypass_strength_v10", type=float, default=1.0)
    parser.add_argument("--f64_hidden_channels_v10", type=int, default=512)
...
if __name__ == "__main__":
    args = get_parser_v10().parse_args()
    hair_fast = HairFast_v10(args)
