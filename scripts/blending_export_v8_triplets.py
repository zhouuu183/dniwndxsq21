...
USER_FACE_ROOT_CELEBAHQ = Path("celeba-1024/celeba-1024")

USER_SHAPE_ROOT_CELEBAHQ = Path("celeba-1024/celeba-1024")
USER_COLOR_ROOT_CELEBAHQ = Path("celeba-1024/celeba-1024")
