...
from hair_swap_v51 import HairFastV51 as HairFast, get_parser
from models.ear_modules_v51 import (
    EarAnchoredQueryBuilder,
    FaceParsingHelperV51,
    HairMaskExtractorV51,
    dilate_mask,
    gaussian_blur,
    high_pass_filter,
)
...
USER_OUTPUT_DIR_SMALL = Path("images/pp_dataset_v51_dual_small")
...
USER_OUTPUT_DIR_FULL = Path("images/pp_dataset_v51_dual_full")
...
def build_parser(defaults):
    parser = argparse.ArgumentParser(description="PP dataset generator v51")
...
class DatasetItemBatchBuilder:
    def __init__(self, args):
        ...
        self.hair_mask_extractor = HairMaskExtractorV51(device=self.device, dilate_erosion=args.smooth)
        self.parsing_helper = FaceParsingHelperV51(parse_size=args.ear_parse_size)
    ...
    def iter_batches(self, experiments, dataset_path, face_gallery_root):
        ...
        for batch in batch_iterator:
            ...
            del source_earring_recall_mask
            if self.device == "cuda":
