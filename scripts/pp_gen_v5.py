...
USER_FACE_GALLERY_DIR_FULL = Path("/data/coding/HairFastGAN/HairFastGAN-main/images/ear")
USER_DONOR_GALLERY_DIR_FULL = Path("/data/coding/HairFastGAN/HairFastGAN-main/imagess/FFHQ_short")
USER_OUTPUT_DIR_FULL = Path("/data/coding/HairFastGAN_to_xcodecopy/images/pp_dataset_v5_dual_full")
