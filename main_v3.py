...
from hair_swap_v3 import HairFast_v3, get_parser_v3


def main(model_args, args):
    hair_fast = HairFast_v3(model_args)
...
if __name__ == "__main__":
    model_parser = get_parser_v3()
    parser = argparse.ArgumentParser(description="HairFast v3 evaluate")
