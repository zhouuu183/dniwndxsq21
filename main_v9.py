...
from hair_swap_v9 import HairFast_v9, get_parser_v9


def main(model_args, args):
    hair_fast = HairFast_v9(model_args)
    ...
    for exp in tqdm(experiments):
        ...
        final_image = hair_fast.swap(
            ...
            exp_name=exp_name,
            use_dgsta_v9=model_args.use_dgsta_v9,
            dgsta_blend_v9=model_args.dgsta_blend_v9,
            satd_boundary_v8=model_args.satd_boundary_v8,
            eq8_reference_blend_v8=model_args.eq8_reference_blend_v8,
        )
        save_image(final_image, output_image_path)


if __name__ == "__main__":
    model_parser = get_parser_v9()
    parser = argparse.ArgumentParser(description="HairFast v9 evaluate")
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("output_v9"), help="The directory for final results")
