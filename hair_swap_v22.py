...
from models.Blending_v22 import Blending_v22
...
class HairFast_v22:
    """
    HairFast v22:
    v8 SATD alignment followed by strict-mask image-space hair color transfer.
    """
    ...
    def __init__(self, args):
        ...
        self.blend = Blending_v22(args, net=self.net)
...
def get_parser_v22():
    parser = argparse.ArgumentParser(description="HairFast v22")
    ...
    parser.add_argument("--v22_checkpoint", type=str, default="")
    parser.add_argument("--v22_ab_strength", type=float, default=0.94)
    parser.add_argument("--v22_ab_std_strength", type=float, default=0.20)
    parser.add_argument("--v22_luma_boost_scale", type=float, default=0.55)
    parser.add_argument("--v22_max_luma_shift", type=float, default=14.0)
    parser.add_argument("--v22_min_luma_shift", type=float, default=-6.0)
    parser.add_argument("--v22_saturation_compress", type=float, default=0.95)
    parser.add_argument("--v22_extreme_ab_scale", type=float, default=0.88)
    parser.add_argument("--v22_luma_gap_threshold", type=float, default=0.12)
    parser.add_argument("--v22_extreme_luma_gap", type=float, default=0.25)
    parser.add_argument("--v22_dark_luma_threshold", type=float, default=28.0)
    parser.add_argument("--v22_light_luma_threshold", type=float, default=62.0)
    parser.add_argument("--v22_shadow_threshold", type=float, default=18.0)
    parser.add_argument("--v22_highlight_threshold", type=float, default=82.0)
    parser.add_argument("--v22_highlight_shadow_ab_scale", type=float, default=0.65)
    parser.add_argument("--v22_bins", type=int, default=7)
    parser.add_argument("--v22_target_erode", type=int, default=2)
    parser.add_argument("--v22_lock_dilate", type=int, default=3)
    parser.add_argument("--v22_alpha_blur_radius", type=int, default=5)
    parser.add_argument("--v22_ref_erode", type=int, default=2)
    parser.add_argument("--v22_ref_l_min", type=float, default=5.0)
    parser.add_argument("--v22_ref_l_max", type=float, default=95.0)
    parser.add_argument("--v22_ref_min_sat", type=float, default=0.02)
    return parser
