...
def main(model_args, args):
    ...
    for exp in tqdm(experiments):
        ...
        final_image = hair_fast.swap(
            ...
            exp_name=exp_name,
            use_satd_v8=model_args.use_satd_v8,
            satd_blend_v8=model_args.satd_blend_v8,
...
if __name__ == "__main__":
    model_parser = get_parser_v8()
    parser = argparse.ArgumentParser(description="HairFast v8 evaluate")
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("output_v8"), help="The directory for final results")
