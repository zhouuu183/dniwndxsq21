...
from models.Alignment_v17 import Alignment_v17
from models.Blending_v17 import Blending_v17
...
class HairFast_v17:
    """
    HairFast v17:
    baseline embedding + SATD-cleaned alignment + SID-Blending.
    """
    ...
    def __init__(self, args):
        ...
        self.align = Alignment_v17(args, self.embed.get_e4e_embed, net=self.net)
        self.blend = Blending_v17(args, net=self.net)
...
def get_parser_v17():
    parser = argparse.ArgumentParser(description="HairFast v17")
    ...
    parser.add_argument("--blending_checkpoint_v17", type=str, default="pretrained_models/Blending/checkpoint.pth")
    parser.add_argument("--clip_model_v17", type=str, default="ViT-B/32")
    parser.add_argument("--pp_checkpoint", type=str, default="pretrained_models/PostProcess/pp_model.pth")
    parser.add_argument("--use_satd_v17", action="store_true")
    parser.add_argument("--satd_checkpoint_v17", type=str, default="")
    parser.add_argument("--satd_blend_v17", type=float, default=0.28)
    parser.add_argument("--satd_boundary_v17", type=int, default=8)
    parser.add_argument("--eq_reference_blend_v17", type=float, default=0.0)
    parser.add_argument("--feature_strength_v17", type=float, default=1.5)
    return parser


if __name__ == "__main__":
    args = get_parser_v17().parse_args()
    HairFast_v17(args)
