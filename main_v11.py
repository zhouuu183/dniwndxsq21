...
def main(model_args, args):
    hair_fast = HairFast_v11(model_args)
...
if __name__ == "__main__":
    model_parser = get_parser_v11()
    parser = argparse.ArgumentParser(description="HairFast v11 evaluate")
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("output_v11"), help="Directory for final images")
