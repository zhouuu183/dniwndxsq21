...
def main(model_args, args):
    ...
    for exp in tqdm(experiments):
        ...
        final_image = hair_fast.swap(
            ...
            exp_name=exp_name,
            use_satd_v4=model_args.use_satd_v4,
            satd_blend_v4=model_args.satd_blend_v4,
            satd_boundary_v4=model_args.satd_boundary_v4,
        )
        save_image(final_image, output_image_path)


if __name__ == "__main__":
    model_parser = get_parser_v4()
    parser = argparse.ArgumentParser(description="HairFast v4 evaluate")
