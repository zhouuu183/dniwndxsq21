...
from models.Blending_v23 import Blending_v23
...
class HairFast_v23:
    """
    v23:
    v8 SATD alignment, followed by strict image-space hair chroma transfer.
    """
    ...
    def __init__(self, args):
        ...
        self.blend = Blending_v23(args, net=self.net)
    ...
    def __swap_from_tensors(self, face: torch.Tensor, shape: torch.Tensor, color: torch.Tensor, **kwargs) -> torch.Tensor:
        ...
        return self.blend.blend_images(align_shape, None, name_to_embed, **kwargs)
...
def get_parser_v23():
    parser = argparse.ArgumentParser(description="HairFast v23")
    ...
    parser.add_argument("--use_satd_v8", action="store_true", default=True)
    ...
    parser.add_argument("--v23_checkpoint", type=str, default="")
    parser.add_argument("--v23_work_size", type=int, default=256)
    parser.add_argument("--v23_bins", type=int, default=7)
    parser.add_argument("--v23_ab_strength", type=float, default=1.0)
    parser.add_argument("--v23_ab_std_strength", type=float, default=0.12)
    parser.add_argument("--v23_main_color_strength", type=float, default=0.18)
    parser.add_argument("--v23_chroma_floor_strength", type=float, default=0.72)
    parser.add_argument("--v23_chroma_floor_min_ref", type=float, default=8.0)
    parser.add_argument("--v23_luma_boost_scale", type=float, default=0.18)
    parser.add_argument("--v23_darken_scale", type=float, default=0.16)
    parser.add_argument("--v23_max_luma_shift", type=float, default=8.0)
    parser.add_argument("--v23_min_luma_shift", type=float, default=-4.0)
    parser.add_argument("--v23_shadow_threshold", type=float, default=18.0)
    parser.add_argument("--v23_highlight_threshold", type=float, default=84.0)
    parser.add_argument("--v23_extreme_luma_chroma_scale", type=float, default=0.68)
    parser.add_argument("--v23_extreme_luma_shift_scale", type=float, default=0.20)
    parser.add_argument("--v23_target_erode", type=int, default=1)
    parser.add_argument("--v23_target_band_dilate", type=int, default=1)
    parser.add_argument("--v23_band_alpha", type=float, default=0.45)
    parser.add_argument("--v23_soft_lock_strength", type=float, default=0.65)
    parser.add_argument("--v23_alpha_blur_radius", type=int, default=3)
    parser.add_argument("--v23_ref_erode", type=int, default=2)
    parser.add_argument("--v23_ref_l_min", type=float, default=5.0)
    parser.add_argument("--v23_ref_l_max", type=float, default=95.0)
    parser.add_argument("--v23_ref_min_sat", type=float, default=0.025)
    return parser
