...
from models.Blending_v3 import Blending_v3
...
class HairFast_v3:
    def __init__(self, args):
        ...
        self.align = Alignment_v3(args, self.embed.get_e4e_embed, net=self.net)
        self.blend = Blending_v3(args, net=self.net)
...
def get_parser_v3():
    parser = argparse.ArgumentParser(description="HairFast v3")
    ...
    parser.add_argument("--use_satd_v3", action="store_true")
    parser.add_argument("--satd_checkpoint_v3", type=str, default="")
    parser.add_argument("--satd_blend_v3", type=float, default=0.35)
    parser.add_argument("--satd_boundary_v3", type=int, default=5)
    return parser


if __name__ == "__main__":
    args = get_parser_v3().parse_args()
    HairFast_v3(args)
