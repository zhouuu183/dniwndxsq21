        ...
        for image, names in self.dataloader:
            ...
            for k, names in enumerate(names):
                for name in names:
                    ...
                    # THO-LER v2 restores accessories in the original aligned
                    # 1024 identity coordinates.  Keep the complete RGB image
                    # instead of reconstructing it from the 256 encoder input.
                    name_to_embed[name]['image_1024'] = image[k].unsqueeze(0)
