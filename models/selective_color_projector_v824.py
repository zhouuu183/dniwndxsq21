"""Deterministic full-color boundary single-alpha projector for V2.24."""
...
FULL_COLOR_ARCH_V8_7 = "full_color_boundary_single_alpha_v824"
...
class BoundaryStableFullColorProjectorV824(nn.Module):
